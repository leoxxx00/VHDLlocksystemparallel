...
HD_PWD='C:/Users/customer/CombinedSystem/CombinedSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CombinedSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CombinedSystem.tcl

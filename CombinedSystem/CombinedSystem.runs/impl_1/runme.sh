...
HD_PWD='C:/Users/customer/CombinedSystem/CombinedSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CombinedSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CombinedSystem.tcl -notrace
